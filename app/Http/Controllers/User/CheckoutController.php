...
class CheckoutController extends Controller
{
    ...
    public function place_order(Request $request)
    {
        ...
        $order->subtotal = str_replace(',', '', Session::get('discounts')['subtotal'] ?? Cart::instance('cart')->subtotal());
        $order->discount = str_replace(',', '', Session::get('discounts')['discount'] ?? 0);
        $order->tax = str_replace(',', '', Session::get('discounts')['tax'] ?? Cart::instance('cart')->tax());
        $order->total = str_replace(',', '', Session::get('discounts')['total'] ?? Cart::instance('cart')->total());
