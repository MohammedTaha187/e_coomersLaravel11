                ...
                <div class="wg-box">
                    ...
                    <fieldset class="name">
                        ...
                        <input class="mb-10" type="text" placeholder="Enter meta keywords (comma separated)"
                            name="meta_keywords" value="{{ old('meta_keywords', $product->meta_keywords) }}">
                    </fieldset>

                    <fieldset class="description">
                        <div class="body-title mb-10">Meta Description</div>
                        <textarea class="mb-10 ht-100" name="meta_description" placeholder="Enter meta description">{{ old('meta_description', $product->meta_description) }}</textarea>
                    </fieldset>
                </div>
                <div class="wg-box">
                    <fieldset>
