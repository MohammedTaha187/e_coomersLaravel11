...
@section('content')
    <main class="pt-90">
        ...
        <section class="shop-checkout container">
            ...
            <form name="checkout-form" action="{{ route('user.checkout.place_order') }}" method="POST">
                @csrf
                            ...
                            <div class="col-md-6">
                                <div class="form-floating my-3">
                                    <input type="text" class="form-control" name="name" required=""
                                        value="{{ old('name', $address ? $address->name : '') }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-floating my-3">
                                    <input type="text" class="form-control" name="zip" required=""
                                        value="{{ old('zip', $address ? $address->zip : '') }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-floating mt-3 mb-3">
                                    <input type="text" class="form-control" name="state" required=""
                                        value="{{ old('state', $address ? $address->state : '') }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-floating my-3">
                                    <input type="text" class="form-control" name="city" required=""
                                        value="{{ old('city', $address ? $address->city : '') }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating my-3">
                                    <input type="text" class="form-control" name="locality" required=""
                                        value="{{ old('locality', $address ? $address->locality : '') }}">
                            ...
                            <div class="col-md-12">
                                <div class="form-floating my-3">
                                    <input type="text" class="form-control" name="landmark" required=""
                                        value="{{ old('landmark', $address ? $address->landmark : '') }}">
                                    ...
                                    <table class="checkout-totals">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td align="right">
                                                    ${{ Session::get('discounts')['subtotal'] - Session::get('discounts')['discount'] }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>SHIPPING</th>
                            ...
                            <div class="checkout__payment-methods">
                                <div class="form-check">
                                    <input class="form-check-input form-check-input_fill" type="radio"
                                        name="checkout_payment_method" id="checkout_payment_method_1" value="card">
