                    ...
                    <div class="swiper-slide">
                        <div class="overflow-hidden position-relative h-100">
                            <div class="slideshow-character position-absolute bottom-0 pos_right-center">
                                <img loading="lazy"
                                    src="{{ $slide->image ? Storage::url($slide->image) : asset('images/placeholder.png') }}"
                                    width="542" height="733" alt=""
                  ...
                  "pagination": false
                        ...
                        <div class="swiper-wrapper">
                            @foreach ($categories as $category)
                                <div class="swiper-slide">
                                    <a href="{{ route('user.shop.index', ['categories' => $category->id]) }}">
                                        <img loading="lazy" class="w-100 h-auto mb-3"
                                            src="{{ $category->image ? Storage::url($category->image) : asset('assets/images/home/demo3/category_1.png') }}"
                                    ...
                                    @foreach ($sale_products as $product)
                                        <div class="swiper-slide product-card product-card_style3">
                                            <div class="pc__img-wrapper">
                                                <a
                                                    href="{{ route('user.shop.product-details', ['product_slug' => $product->slug]) }}">
                                                    <img loading="lazy"
                                                        src="{{ $product->image ? Storage::url($product->image) : asset('assets/images/home/demo3/product-0-1.jpg') }}"
                                            ...
                                            <div class="pc__info position-relative">
                                                ...
                                                <div class="product-card__price d-flex align-items-center">
                                                    <span class="money price-old">${{ $product->price }}</span>
                                                    <span
                                                ...
                                                <div
                                                    ...
                                                    @if (isset($wishlistItems) && array_key_exists($product->id, $wishlistItems))
                                                        <form method="POST"
                                                            ...
                                                            @method('DELETE')
                                                            <button type="submit"
                                                                class="pc__btn-wl bg-transparent border-0 text-danger"
                                                    ...
                                                    @else
                                                        <form method="POST" action="{{ route('user.wishlist.store') }}">
                                                            ...
                                                            <input type="hidden" name="id"
                                                                value="{{ $product->id }}">
                                                            <button type="submit"
                                                                class="pc__btn-wl bg-transparent border-0"
                            ...
                            <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
                                <div class="pc__img-wrapper">
                                    <a
                                        href="{{ route('user.shop.product-details', ['product_slug' => $product->slug]) }}">
                                        <img loading="lazy"
                                            src="{{ $product->image ? Storage::url($product->image) : asset('assets/images/home/demo3/product-4.jpg') }}"
